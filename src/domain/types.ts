...
export const paymentModelLabels: Record<
  PaymentModel,
  { vi: string; en: string }
> = {
...
export const goalLabels: Record<
  GoalKind,
  { vi: string; en: string; unit: "hours" | "money" | "count" }
> = {
  hours_daily: {
    vi: "Giờ làm mỗi ngày",
    en: "Work hours per day",
    unit: "hours",
  },
  hours_weekly: {
    vi: "Giờ làm mỗi tuần",
    en: "Work hours per week",
    unit: "hours",
  },
  earnings_daily: {
    vi: "Thu nhập mỗi ngày",
    en: "Earnings per day",
    unit: "money",
  },
  earnings_weekly: {
    vi: "Thu nhập mỗi tuần",
    en: "Earnings per week",
    unit: "money",
  },
  earnings_monthly: {
    vi: "Thu nhập mỗi tháng",
    en: "Earnings per month",
    unit: "money",
  },
  projects_completed: {
    vi: "Dự án hoàn thành tháng này",
    en: "Completed projects this month",
    unit: "count",
  },
};
