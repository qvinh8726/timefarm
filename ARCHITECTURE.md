...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Desktop shell          | Electron, context isolation, Chromium sandbox, `webSecurity`, no renderer Node integration/`webview`, trusted sender checks, strict navigation/external-origin allowlists, and a packaged React-renderer smoke mode                                           | Installer signing, update channel, clean-machine install/upgrade tests                            |
