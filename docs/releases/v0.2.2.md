...
The migrations and database contract tests are included in the source. Local pgTAP was not completed because the Supabase development stack was unavailable, and the hosted contract check was not run because no hosted URL or public key was supplied. This release therefore makes **no claim of hosted Auth, RLS/RPC, or multi-device verification**.
